...
class RuntimeSettings(BaseSettings):
    ...
    # Hard stops for autonomous fan-out. 0 disables the corresponding limit.
    max_child_agents: int = Field(default=12, ge=0, alias="STRIX_MAX_CHILD_AGENTS")
    max_agent_depth: int = Field(default=3, ge=0, alias="STRIX_MAX_AGENT_DEPTH")
